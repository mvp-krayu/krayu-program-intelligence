...
const ATTENTION_ZONES = {
  ...
  BLOCKERS: { order: 2, id: 'blockers', label: 'Blockers', prominence: 'dominant' },
...
function resolveAttentionHierarchy(journey) {
  ...
  zones.push({
    ...
    emphasis: hasBlockers ? 'escalated' : 'dimmed',
  });
  ...
  const primaryFocus = hasBlockers ? 'blockers' : hasWorkflow ? 'operator_action' : 'current_state';
