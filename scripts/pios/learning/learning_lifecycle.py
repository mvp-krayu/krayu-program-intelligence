...
VALID_TRANSITIONS = {
    ...
    "CONSUMABLE": ["CAPABILITY_CANDIDATE", "SUPERSEDED"],
    "CAPABILITY_CANDIDATE": ["MODULE_CANDIDATE", "SUPERSEDED"],
    "MODULE_CANDIDATE": ["SUPERSEDED"],
    "SUPERSEDED": [],
    "REJECTED": [],
}
...
CONSUMPTION_ELIGIBLE_STATES = {"CONSUMABLE", "CAPABILITY_CANDIDATE", "MODULE_CANDIDATE"}

TERMINAL_STATES = {"SUPERSEDED", "REJECTED"}

OPERATOR_REQUIRED_TRANSITIONS = {
    "PROPOSED", "REVIEWED", "PROMOTED", "CONSUMABLE",
    "CAPABILITY_CANDIDATE", "MODULE_CANDIDATE",
}
