...
| File | Action |
|------|--------|
| `docs/psee/PI.BLUEEDGE.FASTAPI-CONFORMANCE.SIGNAL-RECOMPUTE-AND-BINDING.01/recomputed/signal_projection_fastapi_compatible.json` | CREATED — governed copy from `run_be_orchestrated_fixup_01/41.x/signal_projection.json`; no content modification |
...
Source `artifact`: `signal_projection_fastapi_compatible`
SHA256 match (source = destination): `a467ba0b6541e3a558d90ff55f6754332908f13dc536a0f94440feb73fa17e2d`
