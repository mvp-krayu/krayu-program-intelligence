...
## Definition
Named execution dimension of execution_stability_index. Tracks schedule performance index ratio, drift momentum, and variance volatility to detect compounding schedule pressure.
...
Dimension sub-construct of execution_stability_index. One of five named dimensions contributing to the ESI composite score. Referenced in early warning signal patterns.
...
- SPI-based measurement detail is internal to execution_stability_index
...
- Buffer compression, milestone drift, critical path variance are internal sub-signals — not separate derivative entities
