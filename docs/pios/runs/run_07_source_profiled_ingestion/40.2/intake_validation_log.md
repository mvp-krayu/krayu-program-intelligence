...
evidence_boundary: docs/pios/runs/run_07_source_profiled_ingestion/evidence_boundary.md
...
Evidence intake for run_07_source_profiled_ingestion (BlueEdge v3.23.0) is COMPLETE at the evidence surface level.
