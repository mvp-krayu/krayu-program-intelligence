...
GOVERNED_INTELLIGENCE = [f"INTEL-{i:03d}" for i in range(1, 6)]
...
def run(dry_run: bool = False) -> bool:
    print("=" * 60)
    print("PIOS-40.7 build_diagnosis_artifacts.py")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PIOS-40.7 build diagnosis artifacts")
