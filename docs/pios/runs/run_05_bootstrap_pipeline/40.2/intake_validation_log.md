...
evidence_boundary: docs/pios/runs/run_05_bootstrap_pipeline/evidence_boundary.md
...
Evidence intake for run_05_bootstrap_pipeline (BlueEdge v3.23.0) is COMPLETE at the evidence surface level.
