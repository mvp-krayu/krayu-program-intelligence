...
Locked entity set from docs/pios/runs/run_05_bootstrap_pipeline/40.3/entity_catalog.md. No modification permitted.
...
Locked dependency set from docs/pios/runs/run_05_bootstrap_pipeline/40.3/dependency_map.md. No modification permitted.
...
Locked interface set from docs/pios/runs/run_05_bootstrap_pipeline/40.3/interface_map.md. No modification permitted.
...
Locked node set from docs/pios/runs/run_05_bootstrap_pipeline/40.3/program_execution_graph.md. No modification permitted.
...
structural_truth_source: docs/pios/runs/run_05_bootstrap_pipeline/40.3/
