...
| Input | Status |
|-------|--------|
| docs/pios/runs/run_04_adapter_simulation/40.2/evidence_surface_inventory.md | PRESENT |
| docs/pios/runs/run_04_adapter_simulation/40.2/evidence_classification_map.md | PRESENT |
| docs/pios/runs/run_04_adapter_simulation/40.2/normalized_evidence_map.md | PRESENT |
| docs/pios/runs/run_04_adapter_simulation/40.2/intake_validation_log.md | PRESENT |
| docs/pios/runs/run_04_adapter_simulation/evidence_boundary.md | PRESENT |
...
| Artifact | Status |
|----------|--------|
| docs/pios/runs/run_04_adapter_simulation/40.3/entity_catalog.md | PRODUCED |
| docs/pios/runs/run_04_adapter_simulation/40.3/dependency_map.md | PRODUCED |
| docs/pios/runs/run_04_adapter_simulation/40.3/interface_map.md | PRODUCED |
| docs/pios/runs/run_04_adapter_simulation/40.3/program_execution_graph.md | PRODUCED |
| docs/pios/runs/run_04_adapter_simulation/40.3/structural_traceability_map.md | PRODUCED |
| docs/pios/runs/run_04_adapter_simulation/40.3/reconstruction_validation_log.md | PRODUCED |
