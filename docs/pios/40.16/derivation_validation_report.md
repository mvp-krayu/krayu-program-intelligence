...
**Generated:** 2026-04-01T10:41:17Z
...
|---|---|---|---|
| DVT-01 | Determinism — NF-03 spot check from TC-02 | PASS | W001: NF-03 determinism check passed (DT-007=complete → NF-03=1.0) |
...
| DVT-13 | Run ID consistency across artifacts | PASS | run_id=run_01_blueedge present in all output artifacts |
