...
| P0-2 | Assessment Package generation verification | 4h | Open | Can the complete customer deliverable be generated from LENS? Package includes: Structural Verdict (executive conclusion), findings, Evidence Record, topology capture. Export action: "Export Structural Assessment." The Verdict is one chapter within the package, not a standalone output. |
