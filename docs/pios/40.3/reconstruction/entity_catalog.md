...
**Input:** docs/pios/40.2/normalized_evidence_map.md, docs/pios/40.2/evidence_surface_inventory.md
**Date:** 2026-03-18
**Reconstruction method:** PERM — deterministic entity extraction from normalized evidence
